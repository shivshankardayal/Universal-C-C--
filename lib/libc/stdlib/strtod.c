...
//#define Unsigned_Shifts
    ...
    defined(__powerpc__) || defined(INTERNETC)
#include <sys/types.h>
...
#define word0(x) (ISBIGENDIAN ? ((x).ul[0]):((x).ul[1]))
#define word1(x) (ISBIGENDIAN ? ((x).ul[1]):((x).ul[0]))

#define StoreincBE(a,b,c) \
    (((u_short *)(void *)a)[0] = \
	(u_short)b, ((u_short *)(void *)a)[1] = (u_short)c, a++)

#define StoreincLE(a,b,c) \
    (((u_short *)(void *)a)[0] = \
	(u_short)b, ((u_short *)(void *)a)[1] = (u_short)c, a++)

#define Storeinc(a,b,c) (ISBIGENDIAN ? StoreincBE(a,b,c) : StoreincLE(a,b,c))
#else
