...
GLfloat dolphemit[4] = { 0.01, 0.01, .1, 1.0 };
GLfloat dolphspec[4] = { 0.9, 0.8, .8, 0.5 };
GLfloat dolphdif[4] = { .7, 0.6, .6, 0.5};
GLfloat dolphamb[4] = { 0.3, 0.3, .5, 0.5 };

void dolphin_color(void)
{
    glMaterialfv(GL_FRONT, GL_DIFFUSE, dolphdif);
    glMaterialfv(GL_FRONT, GL_AMBIENT, dolphamb);
    glMaterialfv(GL_FRONT, GL_SPECULAR, dolphspec);
    glMaterialfv(GL_FRONT, GL_EMISSION, dolphemit);
