...
{ "extendtab[(int) %B][(int) %A][0] = CODE_FOR_%(extend%a\%b2%)",
  ...
  "tan_optab->handlers[(int) %A].insn_code = CODE_FOR_%(tan%a2%)",

  "asin_optab->handlers[(int) %A].insn_code = CODE_FOR_%(asin%a2%)",
  "acos_optab->handlers[(int) %A].insn_code = CODE_FOR_%(acos%a2%)",
  "atan_optab->handlers[(int) %A].insn_code = CODE_FOR_%(atan%a2%)",
  "fabs_optab->handlers[(int) %A].insn_code = CODE_FOR_%(fabs%a2%)",
