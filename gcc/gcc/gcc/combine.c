...
#ifdef GCC_ICVM
			x = simplify_rtx (x, op0_mode, i == 15, in_dest);
#else
...
#ifdef GCC_ICVM
/* force size boundaries on bitfields */
	  imode = mode_for_size (GET_MODE_BITSIZE (compute_mode), MODE_INT, 1);
#else
