    ...
    case INTEGER_TYPE:
	  ...
	  || parmtype == java_int_type_node)
        ...
        OB_PUTC ('w');
		   ...
		   parmtype == long_long_integer_type_node
/****** ICVM extensions *******/
			|| parmtype == icvm_TIQI_type_node
			|| parmtype == icvm_unsignedTIQI_type_node
			|| parmtype == icvm_TIHI_type_node
			|| parmtype == icvm_unsignedTIHI_type_node
			|| parmtype == icvm_TISI_type_node
			|| parmtype == icvm_unsignedTISI_type_node
			|| parmtype == icvm_TIDI_type_node
			|| parmtype == icvm_unsignedTIDI_type_node
			|| parmtype == icvm_TISF_type_node
			|| parmtype == icvm_TIDF_type_node
			|| parmtype == icvm_OIQI_type_node
			|| parmtype == icvm_unsignedOIQI_type_node
			|| parmtype == icvm_OIHI_type_node
			|| parmtype == icvm_unsignedOIHI_type_node
			|| parmtype == icvm_OISI_type_node
			|| parmtype == icvm_unsignedOISI_type_node
			|| parmtype == icvm_OIDI_type_node
			|| parmtype == icvm_unsignedOIDI_type_node
			|| parmtype == icvm_OISF_type_node
			|| parmtype == icvm_OIDF_type_node

/****** end ICVM extensions *******/
	       || parmtype == long_long_unsigned_type_node
		   || parmtype == long_long_long_integer_type_node
	       || parmtype == long_long_long_unsigned_type_node
		   || parmtype == long_long_long_long_integer_type_node
	       || parmtype == long_long_long_long_unsigned_type_node
