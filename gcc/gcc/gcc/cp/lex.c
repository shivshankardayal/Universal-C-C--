     ...
     char *filename;
{
  ...
  ridpointers[(int) RID_PAR128] = get_identifier ("__par128__");
  ridpointers[(int) RID_PAR256] = get_identifier ("__par256__");
  ridpointers[(int) RID_SATURATED] = get_identifier ("__saturated__");
