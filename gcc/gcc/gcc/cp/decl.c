...
init_decl_processing ()
{
  ...
  record_builtin_type (RID_MAX, "long long long int", long_long_long_integer_type_node);

  long_long_long_long_integer_type_node = make_signed_type (LONG_LONG_LONG_LONG_TYPE_SIZE);
  record_builtin_type (RID_MAX, "long long long long int", long_long_long_long_integer_type_node);
  ...
  record_builtin_type (RID_MAX, "long long long unsigned int",
		       long_long_long_unsigned_type_node);
  record_builtin_type (RID_MAX, "long long long unsigned",
		       long_long_long_unsigned_type_node);

  long_long_long_long_unsigned_type_node = make_unsigned_type (LONG_LONG_LONG_LONG_TYPE_SIZE);
  record_builtin_type (RID_MAX, "long long long long unsigned int",
		       long_long_long_long_unsigned_type_node);
  record_builtin_type (RID_MAX, "long long long long unsigned",
		       long_long_long_long_unsigned_type_node);
...
/************ ICVM extensions *****************/
  ...
  record_builtin_type(RID_MAX,"__par128__ char", icvm_TIQI_type_node);


  icvm_TIHI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIHI_type_node)=TIHImode;
  record_builtin_type(RID_MAX,"__par128__ short int", icvm_TIHI_type_node);


  icvm_TISI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TISI_type_node)=TISImode;
  record_builtin_type(RID_MAX,"__par128__ int", icvm_TISI_type_node);
  record_builtin_type(RID_MAX,"__par128__ long int", icvm_TISI_type_node);

  icvm_TIDI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIDI_type_node)=TIDImode;
  record_builtin_type(RID_MAX,"__par128__ long long int", icvm_TIDI_type_node);

  icvm_TISF_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TISF_type_node)=TISFmode;
  record_builtin_type(RID_MAX,"__par128__ float", icvm_TISF_type_node);

  icvm_TIDF_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIDF_type_node)=TIDFmode;
  record_builtin_type(RID_MAX,"__par128__ double", icvm_TIDF_type_node);


  icvm_OIQI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIQI_type_node)=OIQImode;
  record_builtin_type(RID_MAX,"__par256__ char", icvm_OIQI_type_node);


  icvm_OIHI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIHI_type_node)=OIHImode;
  record_builtin_type(RID_MAX,"__par256__ short int", icvm_OIHI_type_node);


  icvm_OISI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OISI_type_node)=OISImode;
  record_builtin_type(RID_MAX,"__par256__ int", icvm_OISI_type_node);
  record_builtin_type(RID_MAX,"__par256__ long int", icvm_OISI_type_node);

  icvm_OIDI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIDI_type_node)=OIDImode;
  record_builtin_type(RID_MAX,"__par256__ long long int", icvm_OIDI_type_node);

  icvm_OISF_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OISF_type_node)=OISFmode;
  record_builtin_type(RID_MAX,"__par256__ float", icvm_OISF_type_node);

  icvm_OIDF_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIDF_type_node)=OIDFmode;
  record_builtin_type(RID_MAX,"__par256__ double", icvm_OIDF_type_node);


  icvm_unsignedTIQI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTIQI_type_node)=TIQImode;
  record_builtin_type(RID_MAX,"__par128__ unsigned char", icvm_unsignedTIQI_type_node);

  icvm_unsignedTIHI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTIHI_type_node)=TIHImode;
  record_builtin_type(RID_MAX,"__par128__ short unsigned int", icvm_unsignedTIHI_type_node);
  record_builtin_type(RID_MAX,"__par128__ short unsigned", icvm_unsignedTIHI_type_node);

  icvm_unsignedTISI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTISI_type_node)=TISImode;
  record_builtin_type(RID_MAX,"__par128__ unsigned int", icvm_unsignedTISI_type_node);
  record_builtin_type(RID_MAX,"__par128__ long unsigned int", icvm_unsignedTISI_type_node);
  record_builtin_type(RID_MAX,"__par128__ unsigned long", icvm_unsignedTISI_type_node);

  icvm_unsignedTIDI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTIDI_type_node)=TIDImode;
  record_builtin_type(RID_MAX,"__par128__ long long unsigned", icvm_unsignedTIDI_type_node);
  record_builtin_type(RID_MAX,"__par128__ long long unsigned int", icvm_unsignedTIDI_type_node);

  icvm_unsignedOIQI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOIQI_type_node)=OIQImode;
  record_builtin_type(RID_MAX,"__par256__ unsigned char", icvm_unsignedOIQI_type_node);

  icvm_unsignedOIHI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOIHI_type_node)=OIHImode;
  record_builtin_type(RID_MAX,"__par256__ short unsigned", icvm_unsignedOIHI_type_node);
  record_builtin_type(RID_MAX,"__par256__ short unsigned int", icvm_unsignedOIHI_type_node);

  icvm_unsignedOISI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOISI_type_node)=OISImode;
  record_builtin_type(RID_MAX,"__par256__ unsigned int", icvm_unsignedOISI_type_node);
  record_builtin_type(RID_MAX,"__par256__ long unsigned int", icvm_unsignedOISI_type_node);
  record_builtin_type(RID_MAX,"__par256__ unsigned long", icvm_unsignedOISI_type_node);

  icvm_unsignedOIDI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOIDI_type_node)=OIDImode;
  record_builtin_type(RID_MAX,"__par256__ long long unsigned", icvm_unsignedOIDI_type_node);
  record_builtin_type(RID_MAX,"__par256__ long long unsigned int", icvm_unsignedOIDI_type_node);
...
/************ end ICVM extensions *****************/
  ...
  java_long_long_type_node = record_builtin_java_type ("__java_long_long", 128);
...
/*#ifndef GCC_ICVM  -  BUGGY assumption */
     ...
     tree attrlist;
{
		  ...
		  if (i == (int) RID_LONG && RIDBIT_SETP (i, specbits))
			...
			pedwarn ("ANSI C++ does not support `long long'");
		      if (longlong){
			      if (longlonglong){
				      if (longlonglonglong)
							error ("`long longlong long long' is too long for GCC");
					  else
							longlonglonglong=1;	
				  }else
					longlonglong=1;
  ...
  if (RIDBIT_SETP (RID_UNSIGNED, specbits)
	  ...
	  && RIDBIT_NOTSETP (RID_SIGNED, specbits)))
    {
      if (longlong){
	      if (longlonglong){
		      if (longlonglonglong)
	  			...
	  			if (RIDBIT_SETP (RID_PAR128, specbits))
					type=icvm_unsignedTIDI_type_node;
	  			else if (RIDBIT_SETP (RID_PAR256, specbits))
	  ...
	  else if (RIDBIT_SETP (RID_PAR128, specbits))
			type=icvm_unsignedTISI_type_node;
	  else if (RIDBIT_SETP (RID_PAR256, specbits))
			type=icvm_unsignedOISI_type_node;
      else
