...
extern optab tan_optab;		/* tangent */
extern optab asin_optab;		/* ASine */
extern optab acos_optab;		/* ACosine */
extern optab atan_optab;		/* atangent */
extern optab fabs_optab;		/* fabs */
...
#ifdef GCC_ICVM
/* add the isbitfield flag */
extern rtx store_bit_field PROTO((rtx, int, int, enum machine_mode, rtx, int, int,int));
extern rtx extract_bit_field PROTO((rtx, int, int, int, rtx, enum machine_mode, enum machine_mode, int, int,int));
#else
