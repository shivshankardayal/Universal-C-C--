...
#ifndef LONG_LONG_LONG_TYPE_SIZE
#define LONG_LONG_LONG_TYPE_SIZE (BITS_PER_WORD * 4)
#endif

#ifndef LONG_LONG_LONG_LONG_TYPE_SIZE
#define LONG_LONG_LONG_LONG_TYPE_SIZE (BITS_PER_WORD * 8)
#endif
...
tree long_long_long_integer_type_node;
tree long_long_long_long_integer_type_node;

tree short_unsigned_type_node;
tree unsigned_type_node;
tree long_unsigned_type_node;
tree long_long_unsigned_type_node;
tree long_long_long_unsigned_type_node;
tree long_long_long_long_unsigned_type_node;
...
tree icvm_TIQI_type_node;
tree icvm_unsignedTIQI_type_node;
tree icvm_TIHI_type_node;
tree icvm_unsignedTIHI_type_node;
tree icvm_TISI_type_node;
tree icvm_unsignedTISI_type_node;
tree icvm_TIDI_type_node;
tree icvm_unsignedTIDI_type_node;
tree icvm_TISF_type_node;
tree icvm_TIDF_type_node;

tree icvm_OIQI_type_node;
tree icvm_unsignedOIQI_type_node;
tree icvm_OIHI_type_node;
tree icvm_unsignedOIHI_type_node;
tree icvm_OISI_type_node;
tree icvm_unsignedOISI_type_node;
tree icvm_OIDI_type_node;
tree icvm_unsignedOIDI_type_node;
tree icvm_OISF_type_node;
tree icvm_OIDF_type_node;

/****** end ICVM extended types ****/
...
init_decl_processing ()
{
  ...
  long_long_long_integer_type_node = make_signed_type (LONG_LONG_LONG_TYPE_SIZE);
  pushdecl (build_decl (TYPE_DECL, get_identifier ("long long long int"),
			long_long_long_integer_type_node));

  long_long_long_long_integer_type_node = make_signed_type (LONG_LONG_LONG_LONG_TYPE_SIZE);
  pushdecl (build_decl (TYPE_DECL, get_identifier ("long long long long int"),
			long_long_long_long_integer_type_node));

  long_long_unsigned_type_node = make_unsigned_type (LONG_LONG_TYPE_SIZE);
  pushdecl (build_decl (TYPE_DECL, get_identifier ("long long unsigned int"),
			long_long_unsigned_type_node));

  long_long_long_unsigned_type_node = make_unsigned_type (LONG_LONG_LONG_TYPE_SIZE);
  pushdecl (build_decl (TYPE_DECL, get_identifier ("long long long unsigned int"),
			long_long_long_unsigned_type_node));

  long_long_long_long_unsigned_type_node = make_unsigned_type (LONG_LONG_LONG_LONG_TYPE_SIZE);
  pushdecl (build_decl (TYPE_DECL, get_identifier ("long long long long unsigned int"),
			long_long_long_long_unsigned_type_node));
...
/************ ICVM extensions *****************/
  ...
  icvm_TIQI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIQI_type_node)=TIQImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_TIQI_type_node));


  icvm_TIHI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIHI_type_node)=TIHImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_TIHI_type_node));


  icvm_TISI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TISI_type_node)=TISImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_TISI_type_node));

  icvm_TIDI_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIDI_type_node)=TIDImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_TIDI_type_node));

  icvm_TISF_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TISF_type_node)=TISFmode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_TISF_type_node));

  icvm_TIDF_type_node = make_signed_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_TIDF_type_node)=TIDFmode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_TIDF_type_node));


  icvm_OIQI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIQI_type_node)=OIQImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_OIQI_type_node));


  icvm_OIHI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIHI_type_node)=OIHImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_OIHI_type_node));


  icvm_OISI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OISI_type_node)=OISImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_OISI_type_node));

  icvm_OIDI_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIDI_type_node)=OIDImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_OIDI_type_node));

  icvm_OISF_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OISF_type_node)=OISFmode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_OISF_type_node));

  icvm_OIDF_type_node = make_signed_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_OIDF_type_node)=OIDFmode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_OIDF_type_node));


  icvm_unsignedTIQI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTIQI_type_node)=TIQImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedTIQI_type_node));

  icvm_unsignedTIHI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTIHI_type_node)=TIHImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedTIHI_type_node));

  icvm_unsignedTISI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTISI_type_node)=TISImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedTISI_type_node));

  icvm_unsignedTIDI_type_node = make_unsigned_type (GET_MODE_BITSIZE (TImode));
  TYPE_MODE(icvm_unsignedTIDI_type_node)=TIDImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedTIDI_type_node));

  icvm_unsignedOIQI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOIQI_type_node)=OIQImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedOIQI_type_node));

  icvm_unsignedOIHI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOIHI_type_node)=OIHImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedOIHI_type_node));

  icvm_unsignedOISI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOISI_type_node)=OISImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedOISI_type_node));

  icvm_unsignedOIDI_type_node = make_unsigned_type (GET_MODE_BITSIZE (OImode));
  TYPE_MODE(icvm_unsignedOIDI_type_node)=OIDImode;
  pushdecl (build_decl (TYPE_DECL, NULL_TREE, icvm_unsignedOIDI_type_node));
...
/* if ICVM desires, kill these buggy things off!!! */
  ...
  builtin_function ("__builtin_asinf", float_ftype_float, 
		    BUILT_IN_ASIN, "asinf");
  builtin_function ("__builtin_asin", double_ftype_double, 
		    BUILT_IN_ASIN, "asin");
  builtin_function ("__builtin_acos", double_ftype_double, 
		    BUILT_IN_ACOS, "acos");
  builtin_function ("__builtin_acosf", float_ftype_float, 
		    BUILT_IN_ACOS, "acosf");
  ...
  if (!flag_no_builtin)
    {
      ...
      builtin_function ("tanf", float_ftype_float, BUILT_IN_TAN, NULL_PTR);
      builtin_function ("tan", double_ftype_double, BUILT_IN_TAN, NULL_PTR);
      builtin_function ("cosl", ldouble_ftype_ldouble, BUILT_IN_COS, NULL_PTR);

      builtin_function ("asinf", float_ftype_float, BUILT_IN_ASIN, NULL_PTR);
      builtin_function ("asin", double_ftype_double, BUILT_IN_ASIN, NULL_PTR);
      builtin_function ("acosf", float_ftype_float, BUILT_IN_ACOS, NULL_PTR);
      builtin_function ("acos", double_ftype_double, BUILT_IN_ACOS, NULL_PTR);
      builtin_function ("atanf", float_ftype_float, BUILT_IN_ATAN, NULL_PTR);
      builtin_function ("atan", double_ftype_double, BUILT_IN_ATAN, NULL_PTR);
     ...
     int initialized;
{
	...
	for (i = (int) RID_FIRST_MODIFIER; i < (int) RID_MAX; i++)
	  {
	    if (ridpointers[i] == id)
	      {
		if (i == (int) RID_LONG && specbits & (1LL<<i))
		  {
		    if (longlong){
			    if (longlonglong){
				    if (longlonglonglong)
        				error ("`long long long long long' is too long for GCC");
					else
		   				longlonglonglong = 1;
 				}else
	   				longlonglong = 1;
  ...
  if (type == 0)
    {
      if ((! (specbits & ((1LL << (int) RID_LONG) | (1LL << (int) RID_SHORT)
			  | (1LL << (int) RID_SIGNED)
			  | (1LL << (int) RID_UNSIGNED))))
	  /* Don't warn about typedef foo = bar.  */
	  && ! (specbits & (1LL << (int) RID_TYPEDEF) && initialized)
  ...
  if ((specbits & 1LL << (int) RID_LONG) && ! longlong
      && TYPE_MAIN_VARIANT (type) == double_type_node)
    {
      specbits &= ~ (1LL << (int) RID_LONG);
  ...
  if (specbits & ((1LL << (int) RID_LONG) | (1LL << (int) RID_SHORT)
		  | (1LL << (int) RID_UNSIGNED) | (1LL << (int) RID_SIGNED)))
    {
      int ok = 0;

      if ((specbits & 1LL << (int) RID_LONG)
	  && (specbits & 1LL << (int) RID_SHORT))
	error ("both long and short specified for `%s'", name);
      else if (((specbits & 1LL << (int) RID_LONG)
		|| (specbits & 1LL << (int) RID_SHORT))
	       && explicit_char)
	       ...
	       && TREE_CODE (type) == REAL_TYPE)
	{
      ...
      else if ((specbits & 1LL << (int) RID_SIGNED)
	       && (specbits & 1LL << (int) RID_UNSIGNED))
      ...
      else
	{
      ...
      if (! ok)
	{
	  specbits &= ~((1LL << (int) RID_LONG) | (1LL << (int) RID_SHORT)
			| (1LL << (int) RID_UNSIGNED) | (1LL << (int) RID_SIGNED));
	  longlong = 0;
	}
    }

  if ((specbits & (1LL << (int) RID_COMPLEX))
      && TREE_CODE (type) != INTEGER_TYPE && TREE_CODE (type) != REAL_TYPE)
    {
      error ("complex invalid for `%s'", name);
      specbits &= ~ (1LL << (int) RID_COMPLEX);
    }

  /* Decide whether an integer type is signed or not.
     Optionally treat bitfields as signed by default.  */
  if (specbits & 1LL << (int) RID_UNSIGNED
	  ...
	  && !(specbits & 1LL << (int) RID_SIGNED)))
    {
      if (longlong){
			if(longlonglong){
				if(longlonglonglong)
					type = long_long_long_long_unsigned_type_node;
				else
					type = long_long_long_unsigned_type_node;
			}else{
		        if(specbits & 1LL << (int) RID_PAR128)
					type=icvm_unsignedTIDI_type_node;
		        else if(specbits & 1LL << (int) RID_PAR256)
					type=icvm_unsignedOIDI_type_node;
				else
					type = long_long_unsigned_type_node;
			}
      }else if (specbits & 1LL << (int) RID_LONG){
	        if(specbits & 1LL << (int) RID_PAR128)
				type=icvm_unsignedTISI_type_node;
	        else if(specbits & 1LL << (int) RID_PAR256)
				type=icvm_unsignedOISI_type_node;
			else
				type = long_unsigned_type_node;
      }else if (specbits & 1LL << (int) RID_SHORT){
	        if(specbits & 1LL << (int) RID_PAR128)
				type=icvm_unsignedTIHI_type_node;
	        else if(specbits & 1LL << (int) RID_PAR256)
				type=icvm_unsignedOIHI_type_node;
			else
				type = short_unsigned_type_node;
      }else if (type == char_type_node){
	        if(specbits & 1LL << (int) RID_PAR128)
				type=icvm_unsignedTIQI_type_node;
	        else if(specbits & 1LL << (int) RID_PAR256)
				type=icvm_unsignedOIQI_type_node;
			else
				type = unsigned_char_type_node;
      }else if (typedef_decl && type!=integer_type_node)
			type = unsigned_type (type);
	  else if(specbits & 1LL << (int) RID_PAR128)
			type=icvm_unsignedTISI_type_node;
	  else if(specbits & 1LL << (int) RID_PAR256)
			type=icvm_unsignedOISI_type_node;
      else
		...
		if(type==char_type_node)
			type=icvm_TIQI_type_node;
	     else if (longlong && !longlonglong && !longlonglonglong)
			type=icvm_TIDI_type_node;
	     else if(specbits & 1LL << (int) RID_LONG)
			type=icvm_TISI_type_node;
	     else if(specbits & 1LL << (int) RID_SHORT)
			type=icvm_TIHI_type_node;
		 else if (type==float_type_node)
			type=icvm_TISF_type_node;
		 else if (type==double_type_node)
			type=icvm_TIDF_type_node;
		 else 
			type=icvm_TISI_type_node;
  }else if(specbits & 1LL << (int) RID_PAR256){
		if(type==char_type_node)
			type=icvm_OIQI_type_node;
	     else if (longlong && !longlonglong && !longlonglonglong)
			type=icvm_OIDI_type_node;
	     else if(specbits & 1LL << (int) RID_LONG)
			type=icvm_OISI_type_node;
	     else if(specbits & 1LL << (int) RID_SHORT)
			type=icvm_OIHI_type_node;
		 else if (type==float_type_node)
			type=icvm_OISF_type_node;
		 else if (type==double_type_node)
			type=icvm_OIDF_type_node;
		 else 
			type=icvm_OISI_type_node;
  }else if ((specbits & 1LL << (int) RID_SIGNED) && type == char_type_node){
    type = signed_char_type_node;
  }else if (longlong){
		if(longlonglong){
			if(longlonglonglong)
	   	 		type = long_long_long_long_integer_type_node;
			else
   		 		type = long_long_long_integer_type_node;
		}else
  ...
  constp = !! (specbits & 1LL << (int) RID_CONST) + TYPE_READONLY (type);
  restrictp = !! (specbits & 1LL << (int) RID_RESTRICT) + TYPE_RESTRICT (type);
  volatilep = !! (specbits & 1LL << (int) RID_VOLATILE) + TYPE_VOLATILE (type);
  inlinep = !! (specbits & (1LL << (int) RID_INLINE));
  if (constp > 1)
...

  {
    ...
    if (specbits & 1LL << (int) RID_AUTO) nclasses++;
    if (specbits & 1LL << (int) RID_STATIC) nclasses++;
    if (specbits & 1LL << (int) RID_EXTERN) nclasses++;
    if (specbits & 1LL << (int) RID_REGISTER) nclasses++;
    if (specbits & 1LL << (int) RID_TYPEDEF) nclasses++;
    if (specbits & 1LL << (int) RID_ITERATOR) nclasses++;
    ...
    if (nclasses > 1)
      error ("multiple storage classes in declaration of `%s'", name);
	     ...
	     && (specbits
		 & ((1LL << (int) RID_REGISTER)
		    | (1LL << (int) RID_AUTO)
		    | (1LL << (int) RID_TYPEDEF))))
      {
	if (specbits & 1LL << (int) RID_AUTO
	    && (pedantic || current_binding_level == global_binding_level))
	  pedwarn ("function definition declared `auto'");
	if (specbits & 1LL << (int) RID_REGISTER)
	  error ("function definition declared `register'");
	if (specbits & 1LL << (int) RID_TYPEDEF)
	  error ("function definition declared `typedef'");
	specbits &= ~ ((1LL << (int) RID_TYPEDEF) | (1LL << (int) RID_REGISTER)
		       | (1LL << (int) RID_AUTO));
      }
    else if (decl_context != NORMAL && nclasses > 0)
      {
	if (decl_context == PARM && specbits & 1LL << (int) RID_REGISTER)
	  ;
	else
	  {
	    error ((decl_context == FIELD
		   ...
		   name);
	    specbits &= ~ ((1LL << (int) RID_TYPEDEF) | (1LL << (int) RID_REGISTER)
			   | (1LL << (int) RID_AUTO) | (1LL << (int) RID_STATIC)
			   | (1LL << (int) RID_EXTERN));
	  }
      }
    else if (specbits & 1LL << (int) RID_EXTERN && initialized && ! funcdef_flag)
      {
    ...
    else if (specbits & 1LL << (int) RID_EXTERN && funcdef_flag
	     && current_binding_level != global_binding_level)
      error ("nested function `%s' declared `extern'", name);
    else if (current_binding_level == global_binding_level
	     && specbits & (1LL << (int) RID_AUTO))
      error ("top-level declaration of `%s' specifies `auto'", name);
    else if ((specbits & 1LL << (int) RID_ITERATOR)
  ...
  while (declarator && TREE_CODE (declarator) != IDENTIFIER_NODE)
      ...
      if (TREE_CODE (declarator) == ARRAY_REF)
	{
	  ...
	  int extern_ref = !initialized && (specbits & (1LL << (int) RID_EXTERN));
	...
	{
	  int extern_ref = (!(specbits & (1LL << (int) RID_AUTO))
			    || current_binding_level == global_binding_level);
	  tree arg_types;
  ...
  if (specbits & (1LL << (int) RID_TYPEDEF))
	...
	type = c_build_qualified_type (type, type_quals);
      ...
      if ((specbits & (1LL << (int) RID_SIGNED))
  ...
  if (TYPE_MAIN_VARIANT (type) == void_type_node && decl_context != PARM
      && ! ((decl_context != FIELD && TREE_CODE (type) != FUNCTION_TYPE)
	    && ((specbits & (1LL << (int) RID_EXTERN))
		|| (current_binding_level == global_binding_level
		    && !(specbits
			 & ((1LL << (int) RID_STATIC) | (1LL << (int) RID_REGISTER)))))))
    {
...

  {
	...
	if (current_binding_level != global_binding_level
	    && (specbits & ((1LL << (int) RID_STATIC) | (1LL << (int) RID_INLINE)))
	    && pedantic)
	  pedwarn ("invalid storage class for function `%s'", name);
	...
	TREE_PUBLIC (decl)
	  = !(specbits & ((1LL << (int) RID_STATIC) | (1LL << (int) RID_AUTO)));
	...
	if (inlinep)
	  {
	    ...
	    if (specbits & (1LL << (int) RID_EXTERN))
	...
	/* Not at top level, only `static' makes a static definition.  */
	  ...
	  {
	    TREE_STATIC (decl) = (specbits & (1LL << (int) RID_STATIC)) != 0;
	    TREE_PUBLIC (decl) = DECL_EXTERNAL (decl);
	  }

	if (specbits & 1LL << (int) RID_ITERATOR)
	  ITERATOR_P (decl) = 1;
      }
