...
/* Non-zero if we are demangling the C++ symbols. */
int demangling;
...
#define OPTION_MULTILIB_DIR		(OPTION_FORCE_EXE_SUFFIX + 1)
...
static const struct ld_option ld_options[] =
{
  ...
  { {"demangle", no_argument, NULL, OPTION_DEMANGLE},
      '\0', NULL, "Demangle the C++ symbols", TWO_DASHES },
  ...
  { {"lang", required_argument, NULL, OPTION_LANG},
      '\0', "LANGUAGE", "Set language for demangle", TWO_DASHES },
  { {"Map", required_argument, NULL, OPTION_MAP},
      '\0', "FILE", "Write a map file", ONE_DASH },
  { {"multilib-dir", required_argument, NULL, OPTION_MULTILIB_DIR},
      '\0', "PATH", "Specify a target directory", TWO_DASHES },
  { {"no-demangle", no_argument, NULL, OPTION_NO_DEMANGLE},
      '\0', NULL, "Turn off --demangle", TWO_DASHES },
     ...
     char **argv;
{
  ...
  demangling = ! getenv ("COLLECT_NO_DEMANGLE");
