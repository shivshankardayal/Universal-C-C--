...
reloc_howto_type MY(howto_table)[] =
{
  ...
  HOWTO (18, 0, 2, 32, false, 0, complain_overflow_bitfield, 0, "GOT32", true,
	 0xffffffff, 0xffffffff, false),
  HOWTO (19, 0, 2, 26, true, 0, complain_overflow_bitfield, MY(fix_pcrel_26), 
	 "JMPSLOT", true, 0x00ffffff, 0x00ffffff, true),
     ...
     struct reloc_std_external *natptr;
{
  ...
  /* Is this a PIC relocation? */
  if (g->howto->type & 16)
    r_pic = 1;

  /* jmpslot (branch with pic set) is treated like a branch */
  if (g->howto->type == 19) 
    {
      r_length = 3;
      r_pcrel = 0;
