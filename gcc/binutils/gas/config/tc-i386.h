...
#define RegXMM 0x80000000	/* XMM registers in PIII */
...
#define Prefix 0x1000000	/* is an opcode prefix */
#define Suffix 0x2000000	/* is an opcode suffix - 3DNow! */
#define RegRegmem 0x4000000	/* always put the dest in i.rm.reg. */
