...
extern double hypot __P((double, double)) ICVMERRCALL(SYS_hypot);
extern int isnan __P((double)) ICVMCALL(SYS_isnan);
...
#if !defined(_ANSI_SOURCE) && !defined(_POSIX_C_SOURCE) && \
    !defined(_XOPEN_SOURCE)
extern int isinf __P((double)) ICVMCALL(SYS_isinf);
