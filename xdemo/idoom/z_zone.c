 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: z_zone.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char rcsid[] = "$Id: z_zone.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
void Z_Init(void)
{
  ...
  size_t size = (MIN_RAM*3); // CPhipps - 6 Mb is enough for 
...
//
// Revision 1.2  2001/02/24 01:05:36  bob
// Bug fixes
//
// Revision 1.1  2000/09/22 13:19:39  bob
// Really Bad Fucking Program -- this CVS
//
// Revision 1.1  2000/08/07 18:16:21  bob
// Doom port
//
