 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: m_swap.h,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
#define doom_swap_l(x) ((long)bswap32((long)(x)))
#define doom_swap_s(x) ((short)(bswap16((short)(x))))
...
#define doom_wtohl(x) ((long)bswapBE32((long)(x)))
#define doom_htowl(x) ((long)bswapBE32((long)(x)))
#define doom_wtohs(x) ((short)bswapBE16((short)(x)))
#define doom_htows(x) ((short)bswapBE16((short)(x)))

#define doom_ntohl(x) ((long)bswapBE32((long)(x)))
#define doom_htohl(x) ((long)bswapBE32((long)(x)))
#define doom_ntohs(x) ((short)bswapBE16((short)(x)))
#define doom_htons(x) ((short)bswapBE16((short)(x)))
 ...
 *
 * Revision 1.2  2000/08/14 21:50:06  bob
 * Just saving this
 *
