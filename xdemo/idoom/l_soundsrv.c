 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: l_soundsrv.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: l_soundsrv.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
int main(int argc, const char** argv)
{
    ...
    snd_verbose = 0;
    if (argc >= 3)
      if (!strcasecmp(argv[2], "-devparm"))
	snd_verbose = 1;
    if (argc >= 4)
      if (!strcasecmp(argv[3], "-devparm"))
	snd_verbose = 1;
