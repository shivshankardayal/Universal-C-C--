 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: l_soundgen.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char 
rcsid[] = "$Id: l_soundgen.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
#else
// CPhipps - leave old non-autoconf stuff here, for reference

#if !defined(LINUX) && !defined(SCOOS5)
#include <sys/filio.h>
#endif
