 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: p_setup.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: p_setup.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
static void P_LoadThings (int lump)
{
  ...
  for (i=0; i<numthings; i++)
    {
#ifdef INTERNETC /* alignment problem */
	  mapthing_t mts;
      mapthing_t *mt=&mts;
	  mapthing_t *dt=(mapthing_t *)data + i;
	  memcpy(mt,dt,sizeof(mapthing_t));
#else
...
//
// Revision 1.2  2001/02/24 01:05:35  bob
// Bug fixes
//
