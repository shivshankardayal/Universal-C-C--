 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: r_draw.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: r_draw.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
//  dest = ylookup[dc_yl] + columnofs[dc_x];  
  ...
  // killough 2/1/98: more performance tuning
    ...
    // strange.
#ifdef INTERNETC
		ICVM_BltTranslateScaleCM8To8(dest,source,colormap,
			1,dc_texheight ? dc_texheight : 128,
			1,count,
			0,0,
			0,fracstep,
			0,frac,
...
//
// Revision 1.5  2000/09/19 14:19:35  bob
// More optimization
//
