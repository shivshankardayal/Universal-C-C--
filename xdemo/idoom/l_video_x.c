 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: l_video_x.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: l_video_x.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
// (can't see X letting me manipulate the kb status register directly somehow)
...
#ifdef INTERNETC // Fucking irritating mouse pointer here
	grabMouse=false;
	usemouse=false;
#endif
...
//
// Revision 1.3  2001/02/24 01:05:35  bob
// Bug fixes
//
...
//
// Revision 1.4  2000/08/22 13:11:28  bob
// superficial
//
