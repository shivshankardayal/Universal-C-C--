 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: p_spec.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: p_spec.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
void P_InitPicAnims (void)
{
  ...
  for (i=0 ; animdefs[i].istexture != -1 ; i++)
  {
	...
	{
		long l;
		memcpy(&l,&(animdefs[i].speed),sizeof(l));
		lastanim->speed=LONG(l);
	}
#else
