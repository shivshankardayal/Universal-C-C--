 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: l_system.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: l_system.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
{
#ifdef INTERNETC
  snprintf(buf,sz,"Internet C++ Doom v%s",VERSION);
#else
