 ...
 *-----------------------------------------------------------------------------
 *
 * $Id: d_deh.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $
 *
...
static const char
rcsid[] = "$Id: d_deh.c,v 1.1.1.1 2001/08/23 10:48:18 bob Exp $";
...
extern void A_Detonate(void *);        // killough 8/9/98
extern void A_Mushroom(void *);        // killough 10/98
extern void A_Die(void *);             // killough 11/98
extern void A_Spawn(void *);           // killough 11/98
extern void A_Turn(void *);            // killough 11/98
extern void A_Face(void *);            // killough 11/98
extern void A_Scratch(void *);         // killough 11/98
extern void A_PlaySound(void *);       // killough 11/98
extern void A_RandomJump(void *);      // killough 11/98
extern void A_LineEffect(void *);      // killough 11/98
...
//
// Revision 1.2  2000/08/19 15:46:24  bob
// Fresh update to old source
//
// Revision 1.1  2000/08/07 18:16:11  bob
// Doom port
//
